...
const TodoList = () => {
    ...
    return (
        <div className="flex flex-col w-full max-w-[540px] bg-[#212121] text-[#b8b8b8] mt-[100px] mx-auto mb-[20px] pt-[40px] px-[30px] pb-[70px] rounded-[15px]">
            <form className="flex justify-center w-[90%] mx-auto mb-[50px]">
                <input type="text" placeholder="Write your task here" className="h-[50px] w-[400px] rounded-[60px] rounded-r-[0px] border-[3px] border-r-0 border-solid border-[#303030] bg-[#161616] px-[20px] active:bg-outline-none focus:outline-none" value={inputValue} onChange={(e) => setInputValue(e.target.value)}/>
